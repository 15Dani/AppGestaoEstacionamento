...
namespace AppGestaoEstacionamento
{
    ...
    class Arquivo
    {
        ...
        {
            StreamReader reader = new StreamReader("Carros.txt");
        ...
        {
            StreamReader reader = new StreamReader("Uso.txt");
            ...
            while (!reader.EndOfStream)
            {
                ...
                VagaNodo vaga = vagasArvore.LocalizarVaga(linhaSepara[1]);
                ...
                if (vaga.Vaga.Tipo == estacionamento)
                {
                    // Gerar Placa
                    data = new Data(
                        DateTime.ParseExact(linhaSepara[2], "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, DateTimeStyles.AllowWhiteSpaces));
        ...
        {
            StreamReader reader = new StreamReader("Vagas.txt");
        ...
        public dynamic LeitorEstacionada(PlacaArvore placaArvore, VagaArvore vagaArvore)
        {
            ...
            while (!reader.EndOfStream)
            {
                linha = reader.ReadLine();
                linhaSepara = linha.Split(';');
                CultureInfo teste = new CultureInfo("pt-BR");
                ...
                if (placaArvore != null)
                {
                    ...
                    estacionada = new Estacionada(
                        ...
                        linhaSepara[1],
                        DateTime.ParseExact(linhaSepara[2], "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, DateTimeStyles.AllowWhiteSpaces),
                        DateTime.ParseExact(linhaSepara[3], "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, DateTimeStyles.AllowWhiteSpaces));
