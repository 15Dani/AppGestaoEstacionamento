          ...
          DataNodo raiz;
            ...
            public void Inserir(DataNodo onde, DataNodo novo)
            {
                ...
                else
                {
                    ...
                    {
                        // Não faz difereça repetir, logo não possui tratamento para nodos iguais
                        Console.WriteLine("Repetiu nodo");
                    }
                }
            }
            ...
            public void PrintarDatas(string data)
            {
                ...
                Console.WriteLine("Informações sobre o Estacionamento selecionado");
                ...
                dataNodo.Estacionadas.Sort((a, b) => a.Entrada.CompareTo(b.Entrada));

                // Loop para printar as informações
                dataNodo.Estacionadas.ForEach((value) =>
                {
