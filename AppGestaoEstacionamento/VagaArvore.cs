     ...
     class VagaArvore
        {
            ...
            // Buscar as informações relacionadas ao Veiculo
               VagaNodo vagaNodo = LocalizarVaga(vaga);
                ...
                DateTime inicio = DateTime.ParseExact(valorInit, "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, DateTimeStyles.AllowWhiteSpaces);
                DateTime fim = DateTime.ParseExact(valorFim, "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, DateTimeStyles.AllowWhiteSpaces);
